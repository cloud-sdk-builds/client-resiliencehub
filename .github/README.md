...
[`@aws-sdk/client-resiliencehub`](https://www.npmjs.com/package/@aws-sdk/client-resiliencehub/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resiliencehub@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ON5U2dXy1FxySrM6VcOJK/n2HdqKU3okZYPT6if1+zIWW5NhL+zgLnONza1ihSp2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-resiliencehub": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resiliencehub@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resiliencehub@3.409.0/index.min.mjs": "sha384-ON5U2dXy1FxySrM6VcOJK/n2HdqKU3okZYPT6if1+zIWW5NhL+zgLnONza1ihSp2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-resiliencehub/blob/refs/tags/3.409.0/LICENSE
```
